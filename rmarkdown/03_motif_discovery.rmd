...
celltype.markers %>% 
  write_csv("../data/celltype.motif.markers.csv")

celltype.markers %>%
  ggplot(aes(y=celltype, x=avg_auc)) +
  geom_boxplot() +
  xlim(0.5, 1)
```

There are no good markers for Glutamatergic neurons.
...
plot.access <- function(gene_name, selection = "Astrocytes|Neuron|Oligode|Prec"){
...
```{r}
plot.GEX.ATAC("Dlx5")
ggsave("../figures/TFplots/Dlx5.atac.gex.png", dpi=300, height=3, width=5)

plot.access("Dlx5", selection = "Neuron|Granule|Prec")
ggsave("../figures/TFplots/Dlx5.access.png", dpi=300, height=3, width=12)
```
...
ggsave("../figures/TFplots/Plagl1.atac.gex.png", dpi=300, height=3, width=5)

plot.access("Plagl1")
ggsave("../figures/TFplots/Plagl1.access.png", dpi=300, height=3, width=12)
```


## Neurod2

Neurod2 has been classified by my analysis as a marker gene for Neural Progenitor cells, but also has high expression/accessibility in cells on the way to become glutamatergic neurons. The gene is known for its role in neuron development, but I could not find any information on it being more important for Glutamatergic than GABAergic development.

```{r}
plot.GEX.ATAC("Neurod2")
ggsave("../figures/TFplots/Neurod2.atac.gex.png", dpi=300, height=3, width=5)


plot.access("Neurod2", "Neuron|Progen|Precurs")
ggsave("../figures/TFplots/Neurod2.access.png", dpi=300, height=3, width=12)
```
